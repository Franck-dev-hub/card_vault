...
gantt
    ...
    section Stage 3
        Technical Documentation :15-12-2025, 09-01-2026
    section Stage 4
        MVP Development :12-01-2026, 06-03-2026
    section Stage 5
        Project Closure :09-03-2026, 15-03-2026
    section Stage 6
...
| Steps  | Commentary                                                                                                       |
| ------ | ---------------------------------------------------------------------------------------------------------------- |
| Step 1 | Create the GitHub repository <br>Set up Docker Compose + configure the React, Python, and PostgreSQL environment |
